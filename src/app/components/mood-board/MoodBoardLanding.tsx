        ...
        <Container>
          <div className="text-center max-w-[560px] mx-auto">
            <h2 className="font-['EB_Garamond',Georgia,serif] font-normal text-[28px] md:text-[36px] text-[#0f0f0d] leading-[1.2] mb-3">
              A clear picture beats a thousand words.
            </h2>
            <p className="font-['DM_Sans',sans-serif] text-[13px] text-[#6b6860] leading-[1.7] mb-8">
              Pull your scattered inspiration into one board, let the tool
              build your palette, and hand your designer something they can
              actually work from.
            </p>
            <div className="flex justify-center">
              <PillButton size="lg" onClick={handleCTA}>Create your board</PillButton>
          ...
          <div className="max-w-[760px] mx-auto space-y-8">
            <div>
              <h3 className="font-['EB_Garamond',Georgia,serif] font-normal text-[20px] text-[#0f0f0d] mb-2">
                Why Every Renovation Needs a Mood Board
              </h3>
              <p className="font-['DM_Sans',sans-serif] text-[12px] text-[#6b6860] leading-[1.7]">
                Telling a designer you want something "warm but modern" means
                something different to every person in the room. A mood board
                removes that ambiguity. When you pin actual images of the
                textures, colours, and spatial feel you're after, your designer
                can skip the guessing phase and start proposing solutions that
                already align with your taste.
              </p>
            </div>
            <div>
              <h3 className="font-['EB_Garamond',Georgia,serif] font-normal text-[20px] text-[#0f0f0d] mb-2">
                From Scattered Screenshots to a Cohesive Brief
              </h3>
              <p className="font-['DM_Sans',sans-serif] text-[12px] text-[#6b6860] leading-[1.7]">
                Most homeowners collect inspiration across Instagram saves,
                Pinterest boards, WhatsApp forwards, and camera rolls. By the
                time they sit down with a designer, half those references are
                lost or out of context. Network's Mood Board tool lets you
                centralise everything, tag images with notes, and export the
                result — complete with an auto-generated colour palette.
              </p>
            </div>
            <div>
              <h3 className="font-['EB_Garamond',Georgia,serif] font-normal text-[20px] text-[#0f0f0d] mb-2">
                Pair Your Board with a Design DNA Profile
              </h3>
              <p className="font-['DM_Sans',sans-serif] text-[12px] text-[#6b6860] leading-[1.7]">
                For the most complete brief, start with our Style Quiz to define
                your Design DNA, then build a mood board that brings that
                profile to life visually. Together, the two give any design
                professional a head start — your style preferences in data
                form, backed by the exact reference images that inspired them.
              </p>
            </div>
          </div>
        </Container>
