...
export function FunnelHero() {
  ...
  const pillBadge = (
    <div
      className="inline-flex items-center gap-2.5 mb-5 lg:mb-7 pl-2.5 pr-3.5 py-1.5"
      style={{
        background: C.white,
    ...
    >
      ...
      >
        {homeownerCount} homeowners matched
      </span>
  ...
  const headline = (
    <h1 className="leading-[1.08] mb-5 lg:mb-6">
      <span
  ...
  const subheadline = (
    <p
      className="text-[14px] lg:text-[15px] leading-[1.7] mb-0 lg:mb-8 max-w-[520px]"
      ...
      <div className="max-w-[1240px] mx-auto">
        <div className="grid grid-cols-1 lg:grid-cols-[1.1fr_1fr] gap-8 lg:gap-16 items-start">
          ...
          <motion.div
            ...
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.3, delay: 0.2 }}
            className="order-1 lg:order-2 w-full lg:sticky lg:top-24"
          >
            <CompactLeadForm
              mobileHero={
                <>
