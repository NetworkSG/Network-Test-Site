...
import { furnitureStyleOptions } from "@/app/utils/quiz-data"
...
export function StepFurnitureStyle({ selected, onSelect }: Props) {
  return (
    <div>
      ...
      <p className="font-['DM_Sans',sans-serif] text-[13px] text-[#6b6860] leading-[1.6] mb-8">
        Pick the furniture approach that feels right.
      </p>
      <div className="grid grid-cols-2 md:grid-cols-3 gap-[10px]">
        {furnitureStyleOptions.map(option => (
          <ImageCard
            key={option.id}
